...
object WriteToAccumulo {
  ...
  def main(args: Array[String]) = {
    ...
    val mutations = movies.map { line =>
      val m = // TODO create a mutation with the movieID as the row ID
      // TODO add the genres as the columnFamily and the title as the value
    ...
    // TODO use  saveAsNewAPIHadoopFile to store the mutations in Accumulo
    mutations.
